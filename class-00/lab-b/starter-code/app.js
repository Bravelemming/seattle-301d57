...
// this is undefined, because this has no reference inside an anonymous arrow function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//  this is undefined, because this has no reference inside an anonymous arrow function.
// 3. Explain why "this" is different when an arrow function is used.
//  this refers to the object where the function is being called.  inside a constructor, thats the object being created.  inside an anonymous function, it depends where its being called  -- The 'this' value of the enclosing lexical scope is used.
